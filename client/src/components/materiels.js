...
const Materiels = () => {
    return (
        <div className="container">
            <h1>Ici,vous trouverez les remorques de haute qualité que nous possédons pour tous vos besoins de transport</h1>
            <div className="text-center mb-3">
                <Link to="/devis" className="btn btn-primary px-4 py-2 fs-4">Demander un Devis</Link>
            </div>
            <div className="row">
